...
How can you find out what Cmdlets are available?
  ...
  1. At the prompt type:
    ...
    ![](/posts/files/dne-dcip-powershell-introduction-v01/assets/images/image-11.jpg)<br/><br/>
  ...
  Cmdlets follow a naming scheme <strong>Verb-Noun</strong> or <strong>Action-Thing</strong>
  ...
  Just how many <strong>Get</strong> Cmdlets are on your system?<br/><br/>
  ...
  3. At the prompt type
    ...
    ![](/posts/files/dne-dcip-powershell-introduction-v01/assets/images/image-12.jpg)<br/><br/>
...
We've started the discussion of PowerShell by introducing some basic examples and a few PowerShell terms. If you're ready to go deeper into Cmdlets and Objects, be sure to try the lab <strong>PowerShell - Cmdlets and Objects</strong>!
