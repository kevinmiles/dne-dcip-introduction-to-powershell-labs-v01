...
2. Run the `Send-WebexForTeamsMessage.ps1` Cmdlet, specify the following parameters:
  ...
  ```PowerShell
  .\Send-WebexForTeamsMessage.ps1 -apiToken "ZDNiZmFiOWEtN2Y3Zi00YjI3LWI3NWItYmNkNzQxOTUyYmZiNWQ0ZTY5N2ItOT" -roomName "DevNet Express DCI Event Room" -message "I have completed the Introduction to PowerShell Basic Mission"
  ```
